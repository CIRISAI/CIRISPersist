    ...
    "ciris-persist criterion benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3e8eab5757bceda5470902142cc8f2dbbc2e6e69",
          "message": "v6.1.0 — retention PyO3 FFI surface (#218) + injection-gate error-class fix\n\nExposes MaintenanceService set/get/list/run_retention on the PyO3 Engine\n(both backends via BackendDispatch), JSON-over-FFI consistent with the\nmaintenance cluster. Delivers the \"thin follow-up\" 5.9.0 deferred; unblocks\nCIRISLens#21 / CIRISLensCore#51.\n\nFixes a carried-in #209 mis-classification: validate_sql_identifier returned\nError::Backend (retryable Transient) for a malformed/injection-shaped\nidentifier — corrected to Error::InvalidArgument (Permanent), since such an\nidentifier can never succeed on retry.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-13T14:12:43-05:00",
          "tree_id": "2ab48a1b03779b4384c0e6e002d25a7152fcec5f",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/3e8eab5757bceda5470902142cc8f2dbbc2e6e69"
        },
        "date": 1781380023358,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3ce233864b7bf51ae4729eec3d8bdaea01ca0e2e",
          "message": "v6.2.0 — membership-change re-key keystone + roster-grow primitive (#161 A4-5, #152-r1)\n\nMerge Lane A: the symmetric half of the self/family at-rest cascade —\nretroactive key-grant ADD re-wrap for newcomers (past blobs) + the\nadd_family_member roster-grow primitive (future writes), making membership\naddition first-class and symmetric with V067 removal. Producer stop-wrapping\nforward-secrecy fix; family_membership_change/recipient_excluded hard_case;\nV077 visibility-set index. Both backends + memory; sqlite + live-PG green.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-13T14:29:37-05:00",
          "tree_id": "2dcd1cb4780dfec6bdd4f79ff9d75c1780df9381",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/3ce233864b7bf51ae4729eec3d8bdaea01ca0e2e"
        },
        "date": 1781382092207,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0dbe8942f483992aee6a162f20b507843e879a38",
          "message": "v6.3.0 — federation read accessors for lens-core multimedia detectors (#135)\n\nEngine::list_attestations / list_takedowns_for / list_key_grants_for — the\nRust-public read facades CIRISLensCore#29's §29.1/§29.3/§29.4 detectors join\non, composing over landed Phase-4 storage (no new SQL). Returns the actual\nlanded row types (Attestation / ContributionEnvelope), not the issue's\npre-Phase-4 illustrative Signed* shapes. Both backends; sqlite + live-PG.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-13T15:36:27-05:00",
          "tree_id": "ed4f671157f05d4872cb7cef47524f3aa052517e",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/0dbe8942f483992aee6a162f20b507843e879a38"
        },
        "date": 1781384437675,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b836e3c3af4ef738eca35ffeecc00c79d82c1807",
          "message": "v6.4.0 — broadened withdraws admission gate (#146 Ask 2)\n\nMerge Lane B: the 4-rule consent-revocation authority gate on put_attestation\n(producer / subject / consent-delegate chain / delegation), with the\nadmitting rule recorded for read-side weighting; §8.1.11.2 multi-subject\nindependent authority; scoped to consent withdraws (moderation/system\nwithdraws against holds_bytes directory rows bypass, authorized upstream);\nadmit-deferred on out-of-order absent-T. No migration. Full feature set 1394\nlib tests + live-PG green.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-13T17:00:12-05:00",
          "tree_id": "816f18ace2f2560e79fad4e7ac9f164a1b4eee22",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/b836e3c3af4ef738eca35ffeecc00c79d82c1807"
        },
        "date": 1781389749037,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2a253f40a4c1bcb6d71df84c7fc83c4b89a21ef1",
          "message": "v6.5.0 — Self-at-login substrate (#183, CEG §8.1.12.7)\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-13T17:33:37-05:00",
          "tree_id": "d67b719ab0879ce154d0e9eb08d50653b0f0db66",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/2a253f40a4c1bcb6d71df84c7fc83c4b89a21ef1"
        },
        "date": 1781391639072,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "88333a917874febaf0e22e472b26c31defed165a",
          "message": "Engine::with_hardware_signer — from-scratch TPM federation signer ctor (#220) (#221)\n\n* Engine::with_hardware_signer — from-scratch TPM federation signer ctor (#220)\n\nAdd a from-scratch constructor mirroring with_signer (build_backend + run\nmigrations) that stores an externally-supplied Arc<dyn HardwareSigner> directly\n(local_signer: None, like from_shared). Lets a host (CIRISServer, the fabric\nnode) give the Engine a TPM/SE/StrongBox federation signing identity via\nciris_keyring::get_platform_signer (software fallback handled there), so the\nsigning key need never be read into the process.\n\nAdditive; with_signer (software seed) unchanged. version 6.5.0 -> 6.6.0.\nVerified: cargo build --features postgres,sqlite.\n\nCo-Authored-By: Claude Opus 4.8 (1M context) <noreply@anthropic.com>\n\n* test: with_hardware_signer migrates + is hardware-only (#220)\n\nSmoke test for the new ctor: successful construction proves build_backend\nran migrations (unlike from_shared), a directory read proves the schema is\nlive, and sign_hybrid → LocalSignerUnavailable proves the hardware-only\nlocal_signer:None shape. Mirrors the existing from_shared test idiom.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\n\n---------\n\nCo-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com>",
          "timestamp": "2026-06-14T08:23:56-05:00",
          "tree_id": "543d0aba2b46c67b2359355a58e9c489a76d8a5b",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/88333a917874febaf0e22e472b26c31defed165a"
        },
        "date": 1781445099486,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e5f10a8ae810fecac7d4997c6038438167dd57c6",
          "message": "docs: CHANGELOG 6.6.0 entry (with_hardware_signer #220)\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T08:25:19-05:00",
          "tree_id": "94929ac6d66670e17d5e5359a5c68e4befab4192",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/e5f10a8ae810fecac7d4997c6038438167dd57c6"
        },
        "date": 1781445183286,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d97b0afc65b172fe5522fd9bd5faab946e3a8598",
          "message": "v6.6.1 — CIRISVerify 5.2.0 → 5.3.0 coherence re-pin (for CIRISServer)\n\nAll three verify pins flip together (ciris-verify-core/ciris-crypto/\nciris-keyring + tpm/ios/android target tables) so the graph resolves to one\nciris_crypto — CIRISServer composes persist + verify in one process.\nAdditive on persist's side (no API change); full feature set + sqlite +\nlive-PG (1364 lib tests) green. 5.3.0 = the CEG 1.0-RC5 verification surface\nthe unblocked consent clauses (#146 Ask 5/6, #161 Ask 5) will consume next.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T10:56:25-05:00",
          "tree_id": "4561d054ac506766a5a06843ccc709130f02b549",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/d97b0afc65b172fe5522fd9bd5faab946e3a8598"
        },
        "date": 1781454072316,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "93b1efa7a3bf1a840afeb1dc093e8212a542991e",
          "message": "6.7.0 base — CIRISVerify 5.3.0 → 5.3.1 re-pin (CEG RC5 conformance)\n\nAll six verify pins flip to v5.3.1 (the RC5-conformant build: multi-role\nsteward identity_type set-membership fix in provenance.rs). Base for the\n6.7.0 consent-clause lane (#161 Ask 5, #146 Ask 5/6). Additive; full feature\nset + sqlite + live-PG (1364 lib tests) green. CHANGELOG lands with the cut.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T11:10:46-05:00",
          "tree_id": "46ba62bfdd9f6cfb6c5be7972ebddb3949fa367d",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/93b1efa7a3bf1a840afeb1dc093e8212a542991e"
        },
        "date": 1781455144207,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "659e220a03ecf498460477e8ea8e483e466fdfc5",
          "message": "docs: note verify 5.3.1 re-pin in 6.7.0 CHANGELOG\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T11:43:38-05:00",
          "tree_id": "c997f29faefd609695ad843a6c41582712d6de22",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/659e220a03ecf498460477e8ea8e483e466fdfc5"
        },
        "date": 1781456964446,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "660efe78270801f6017fdb9f8075e6dbae13a7be",
          "message": "v6.7.1 — build_delegation_graph reads array-shaped delegation scope (#219)\n\ntopology.rs read delegates_to envelope `scope` as a bare string only, so\nself-at-login delegations (scope = array of §8.1.12.7 tokens) came out of\nbuild_delegation_graph with empty DelegationEdge.scope. envelope_field_str_or_set\nnow accepts string OR array (array → comma-joined set-as-string), so scope-\nfiltering DelegationGraph consumers (CIRISEdge#108 wire-layer authority gate)\nget the token set for both shapes. Non-breaking (scope stays String);\nbare-string scopes untouched. Unit test: string/array/real self-at-login\nenvelope/empty-fallback.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T12:26:11-05:00",
          "tree_id": "fd07a4812075d4d32ab912303062561706db9cd8",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/660efe78270801f6017fdb9f8075e6dbae13a7be"
        },
        "date": 1781459659180,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8874ab4f804ce8a7832a5bc7b7325dfa93248baa",
          "message": "v6.7.2 — CIRISVerify 5.3.1 → 5.4.0 coherence re-pin\n\nAll six verify pins flip together (ciris-verify-core/ciris-crypto/ciris-keyring\n+ tpm/ios/android target tables) → single ciris_crypto in the graph for the\npersist+verify-in-one-process consumers (CIRISServer/edge). 5.4.0 lands the\nverify-side transport_binding verifier (#28), FIPS 203 ML-KEM-768 KAT (#53 P4),\nHW-token interface abstraction (#62). Additive on persist's side; full feature\nset + sqlite + live-PG (1380 lib tests) green.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T13:12:51-05:00",
          "tree_id": "a40cadc2ee50f7a159d2a87d8c3c14c84c21a9cd",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/8874ab4f804ce8a7832a5bc7b7325dfa93248baa"
        },
        "date": 1781462330246,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c6a4c83ce5594e4100c2ec8b39ce4a9fd0644b34",
          "message": "Merge Lane I (disk-pressure #148/#149) into 6.8.0",
          "timestamp": "2026-06-14T13:19:25-05:00",
          "tree_id": "e40f31e996eaef75483893ecfa8a9d71a43c91fe",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/c6a4c83ce5594e4100c2ec8b39ce4a9fd0644b34"
        },
        "date": 1781462886117,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "94c21c35e605fb07dd8b3a8b2f9c179299f914f4",
          "message": "v6.8.1 — gate disk-pressure test helpers under sqlite (no-backend -D warnings)\n\nv6.8.0's tag CI failed at darwin-aarch64 (no postgres): TWO_GIB/FOUR_HUNDRED_MIB\nconsts + blob_for were dead_code under `--features server` (no backend) →\n-D warnings build failure. Now #[cfg(feature=\"sqlite\")]-gated like their\nconsumers. Publish is tag-gated so v6.8.0 never reached PyPI (CI-failure\ntombstone); 6.8.1 is the published 6.8 cut, identical feature content\n(scoring #196/#197 + disk-pressure #148/#149 + verify 5.4.0).\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T14:03:45-05:00",
          "tree_id": "26ca1d50d3a30007c45e0816c4201be2dd91e727",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/94c21c35e605fb07dd8b3a8b2f9c179299f914f4"
        },
        "date": 1781465555793,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "962e67fd8395e4e8bf29f5ce2eec51cbe2bc3c3a",
          "message": "v6.8.2 — CIRISVerify 5.4.0 → 5.6.0 security-audit remediation re-pin\n\n5.6.0 = consolidated security release: license-sig verify fail-closed (#72),\nreal TPM2 seal/unseal + honest is_hardware_backed (#73), RNG fail-secure\nkeygen — Ed25519Signer/P256Signer::random() now return Result (#74), and\ncompute_destination_hash §5.6.8.8.1.1 shared producer↔consumer (#28). Six\nverify pins flip together (single ciris_crypto). Near-additive on persist:\none test fixture adopts the new Result (.expect); no production-code change.\nclippy + no-backend -D warnings + sqlite + live-PG (1412 tests) green.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>",
          "timestamp": "2026-06-14T21:03:53-05:00",
          "tree_id": "ab85bcad3f316c0e699398128e298520caf4a5f1",
          "url": "https://github.com/CIRISAI/CIRISPersist/commit/962e67fd8395e4e8bf29f5ce2eec51cbe2bc3c3a"
        },
        "date": 1781490548490,
        "tool": "cargo",
        "benches": [
