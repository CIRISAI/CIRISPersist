...
-- SQLite twin of postgres/lens/V135__trace_thought_signatures.sql — same
-- columns, same nullability, same index name. Schema qualifier dropped,
-- matching this dialect's existing trace_events.
--
-- ─── The defect ─────────────────────────────────────────────────────
--
...
CREATE TABLE IF NOT EXISTS trace_thought_signatures (
    thought_id           TEXT PRIMARY KEY,
    signature_ml_dsa_65  TEXT NOT NULL,
    pqc_key_id           TEXT
);

INSERT INTO trace_thought_signatures (thought_id, signature_ml_dsa_65, pqc_key_id)
...
DROP INDEX IF EXISTS trace_events_pqc_key;

ALTER TABLE trace_events DROP COLUMN signature_ml_dsa_65;
ALTER TABLE trace_events DROP COLUMN pubkey_ml_dsa_65;
