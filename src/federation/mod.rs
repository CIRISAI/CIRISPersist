...
pub use blobs::{
    ...
    GroupDekRef, ManifestRowSpec, PreparedHoldsBytes, PutBlobAttestation, PutBlobScopedResult,
    ScopeBlobSymbol, StorageFloor, StreamChunkRef, StreamChunks, StreamClaim, StreamHead,
