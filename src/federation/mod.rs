...
// CIRISPersist#884 (`FSD/SELF_COLLECTIVE_TRANSFER.md`) — the send set of a SelfOwn record: the
// consent peers plus the self-collective (and, for family, the members' collectives).
