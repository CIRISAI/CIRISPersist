...
pub use admission::{
    ...
    withdraw_canonical_role, withdraw_infra_attest_role, AttestationLadderTransitionPolicy,
    CanonicalWithdrawal, DimensionAdmissionPolicy, DimensionRejectionReason, ReachabilityVerdict,
    ReservedPrefixRule, RoleWithdrawal, ATTESTATION_LADDER_MECHANISMS,
};
