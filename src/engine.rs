...
pub struct Engine {
    ...
    disk_pressure_state: Option<tokio::sync::watch::Receiver<crate::federation::DiskPressureSnapshot>>,
...
impl Engine {
    ...
    pub async fn serve_blob_to_peer(
        ...
        if pressure.refuses_proxy_serves {
            ...
            let is_protected = local_holders
                .iter()
                .any(|k| self.is_local_or_family_key(k));
            if !is_protected {
                return Err(crate::federation::BlobError::DiskPressureProxyRefused {
                    operation: "serve",
                    tier: pressure.tier.label(),
